...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 8b 75 10 80 	movl   $0x8010758b,(%esp)
...
801009a6:	81 ec 1c 01 00 00    	sub    $0x11c,%esp
...
801009b1:	c7 40 7c 00 10 00 00 	movl   $0x1000,0x7c(%eax)
  uint argc, sz, sp, ustack[3+MAXARG+1];
  struct elfhdr elf;
  struct inode *ip;
  struct proghdr ph;
...
801009b8:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
801009ba:	e8 51 21 00 00       	call   80102b10 <begin_op>

  if((ip = namei(path)) == 0){
801009bf:	8b 45 08             	mov    0x8(%ebp),%eax
801009c2:	89 04 24             	mov    %eax,(%esp)
801009c5:	e8 36 15 00 00       	call   80101f00 <namei>
801009ca:	85 c0                	test   %eax,%eax
801009cc:	89 c3                	mov    %eax,%ebx
801009ce:	0f 84 b4 01 00 00    	je     80100b88 <exec+0x1e8>
    end_op();
    cprintf("exec: fail\n");
    return -1;
  }
...
801009d7:	e8 d4 0c 00 00       	call   801016b0 <ilock>
  pgdir = 0;
...
801009f9:	e8 62 0f 00 00       	call   80101960 <readi>
...
80100a06:	e8 05 0f 00 00       	call   80101910 <iunlockput>
    end_op();
80100a0b:	e8 70 21 00 00       	call   80102b80 <end_op>
  }
  return -1;
80100a10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80100a15:	81 c4 1c 01 00 00    	add    $0x11c,%esp
80100a1b:	5b                   	pop    %ebx
80100a1c:	5e                   	pop    %esi
80100a1d:	5f                   	pop    %edi
80100a1e:	5d                   	pop    %ebp
...
80100a49:	0f 84 f2 00 00 00    	je     80100b41 <exec+0x1a1>
80100a4f:	31 c0                	xor    %eax,%eax
80100a51:	89 b5 ec fe ff ff    	mov    %esi,-0x114(%ebp)
80100a57:	89 c6                	mov    %eax,%esi
...
80100a96:	e8 c5 0e 00 00       	call   80101960 <readi>
...
80100ada:	e8 31 5e 00 00       	call   80106910 <allocuvm>
...
80100b1b:	e8 30 5d 00 00       	call   80106850 <loaduvm>
...
80100b31:	e8 fa 5e 00 00       	call   80106a30 <freevm>
...
80100b44:	e8 c7 0d 00 00       	call   80101910 <iunlockput>
  end_op();
80100b49:	e8 32 20 00 00       	call   80102b80 <end_op>
  ip = 0;
...
80100b54:	c7 44 24 08 fc df ff 	movl   $0x7fffdffc,0x8(%esp)
80100b5b:	7f 
80100b5c:	c7 44 24 04 fc ff ff 	movl   $0x7ffffffc,0x4(%esp)
80100b63:	7f 
80100b64:	89 04 24             	mov    %eax,(%esp)
80100b67:	e8 a4 5d 00 00       	call   80106910 <allocuvm>
80100b6c:	85 c0                	test   %eax,%eax
80100b6e:	75 33                	jne    80100ba3 <exec+0x203>
  freevm(oldpgdir);
  return 0;
 ...
 bad:
  if(pgdir)
    freevm(pgdir);
80100b70:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100b76:	89 04 24             	mov    %eax,(%esp)
80100b79:	e8 b2 5e 00 00       	call   80106a30 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
  return -1;
80100b7e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100b83:	e9 8d fe ff ff       	jmp    80100a15 <exec+0x75>
  ...
  if((ip = namei(path)) == 0){
    end_op();
80100b88:	e8 f3 1f 00 00       	call   80102b80 <end_op>
    cprintf("exec: fail\n");
80100b8d:	c7 04 24 21 6f 10 80 	movl   $0x80106f21,(%esp)
80100b94:	e8 b7 fa ff ff       	call   80100650 <cprintf>
    return -1;
80100b99:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100b9e:	e9 72 fe ff ff       	jmp    80100a15 <exec+0x75>
  // Allocate two pages at the next page boundary.
  // Make the first inaccessible.  Use the second as the user stack.
  sz = PGROUNDUP(sz);
  if( (allocuvm(pgdir, STACKTOP, STACKTOP-(PGSIZE*2))) == 0)
...
80100ba3:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100ba9:	c7 44 24 04 fc df ff 	movl   $0x7fffdffc,0x4(%esp)
80100bb0:	7f 
80100bb1:	89 04 24             	mov    %eax,(%esp)
80100bb4:	e8 a7 5f 00 00       	call   80106b60 <clearpteu>
  sp = STACKTOP;


  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100bb9:	8b 45 0c             	mov    0xc(%ebp),%eax
80100bbc:	8b 00                	mov    (%eax),%eax
80100bbe:	85 c0                	test   %eax,%eax
80100bc0:	0f 84 61 01 00 00    	je     80100d27 <exec+0x387>
80100bc6:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  // Make the first inaccessible.  Use the second as the user stack.
  sz = PGROUNDUP(sz);
  if( (allocuvm(pgdir, STACKTOP, STACKTOP-(PGSIZE*2))) == 0)
    goto bad;
  clearpteu(pgdir, (char*)(STACKTOP-(PGSIZE*2))); //clear pte of first page to create buffer
  sp = STACKTOP;
80100bc9:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
80100bce:	89 b5 ec fe ff ff    	mov    %esi,-0x114(%ebp)
80100bd4:	8d 51 04             	lea    0x4(%ecx),%edx


  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100bd7:	89 cf                	mov    %ecx,%edi
80100bd9:	31 c9                	xor    %ecx,%ecx
80100bdb:	89 d6                	mov    %edx,%esi
80100bdd:	89 ca                	mov    %ecx,%edx
80100bdf:	eb 0f                	jmp    80100bf0 <exec+0x250>
80100be1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80100be8:	83 c6 04             	add    $0x4,%esi
    if(argc >= MAXARG)
80100beb:	83 fa 20             	cmp    $0x20,%edx
80100bee:	74 80                	je     80100b70 <exec+0x1d0>
      goto bad;
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
80100bf0:	89 04 24             	mov    %eax,(%esp)
80100bf3:	89 95 f0 fe ff ff    	mov    %edx,-0x110(%ebp)
80100bf9:	e8 a2 38 00 00       	call   801044a0 <strlen>
80100bfe:	f7 d0                	not    %eax
80100c00:	01 c3                	add    %eax,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100c02:	8b 07                	mov    (%edi),%eax
...
80100c0a:	e8 91 38 00 00       	call   801044a0 <strlen>
80100c0f:	83 c0 01             	add    $0x1,%eax
80100c12:	89 44 24 0c          	mov    %eax,0xc(%esp)
80100c16:	8b 07                	mov    (%edi),%eax
80100c18:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80100c1c:	89 44 24 08          	mov    %eax,0x8(%esp)
80100c20:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100c26:	89 04 24             	mov    %eax,(%esp)
80100c29:	e8 52 61 00 00       	call   80106d80 <copyout>
80100c2e:	85 c0                	test   %eax,%eax
80100c30:	0f 88 3a ff ff ff    	js     80100b70 <exec+0x1d0>
      goto bad;
    ustack[3+argc] = sp;
80100c36:	8b 95 f0 fe ff ff    	mov    -0x110(%ebp),%edx
80100c3c:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
  clearpteu(pgdir, (char*)(STACKTOP-(PGSIZE*2))); //clear pte of first page to create buffer
  sp = STACKTOP;
  ...
  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100c42:	89 f7                	mov    %esi,%edi
80100c44:	8b 06                	mov    (%esi),%eax
    if(argc >= MAXARG)
      goto bad;
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
      goto bad;
    ustack[3+argc] = sp;
80100c46:	89 9c 95 64 ff ff ff 	mov    %ebx,-0x9c(%ebp,%edx,4)
  clearpteu(pgdir, (char*)(STACKTOP-(PGSIZE*2))); //clear pte of first page to create buffer
  sp = STACKTOP;
  ...
  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100c4d:	83 c2 01             	add    $0x1,%edx
80100c50:	85 c0                	test   %eax,%eax
80100c52:	75 94                	jne    80100be8 <exec+0x248>
80100c54:	8b b5 ec fe ff ff    	mov    -0x114(%ebp),%esi
80100c5a:	89 d0                	mov    %edx,%eax
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
      goto bad;
    ustack[3+argc] = sp;
  ...
  ustack[3+argc] = 0;
80100c5c:	c7 84 85 64 ff ff ff 	movl   $0x0,-0x9c(%ebp,%eax,4)
80100c63:	00 00 00 00 

  ustack[0] = 0xffffffff;  // fake return PC
  ustack[1] = argc;
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c67:	89 da                	mov    %ebx,%edx
    ustack[3+argc] = sp;
  }
  ustack[3+argc] = 0;
  ...
  ustack[0] = 0xffffffff;  // fake return PC
  ustack[1] = argc;
80100c69:	89 85 5c ff ff ff    	mov    %eax,-0xa4(%ebp)
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c6f:	8d 04 85 04 00 00 00 	lea    0x4(,%eax,4),%eax
80100c76:	29 c2                	sub    %eax,%edx

  sp -= (3+argc+1) * 4;
80100c78:	83 c0 0c             	add    $0xc,%eax
80100c7b:	29 c3                	sub    %eax,%ebx
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c7d:	89 44 24 0c          	mov    %eax,0xc(%esp)
80100c81:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100c87:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80100c8b:	89 5c 24 04          	mov    %ebx,0x4(%esp)
      goto bad;
    ustack[3+argc] = sp;
  }
  ustack[3+argc] = 0;
  ...
  ustack[0] = 0xffffffff;  // fake return PC
80100c8f:	c7 85 58 ff ff ff ff 	movl   $0xffffffff,-0xa8(%ebp)
80100c96:	ff ff ff 
  ustack[1] = argc;
  ustack[2] = sp - (argc+1)*4;  // argv pointer
...
80100c99:	89 04 24             	mov    %eax,(%esp)
  ...
  ustack[1] = argc;
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c9c:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)

  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca2:	e8 d9 60 00 00       	call   80106d80 <copyout>
80100ca7:	85 c0                	test   %eax,%eax
80100ca9:	0f 88 c1 fe ff ff    	js     80100b70 <exec+0x1d0>
    goto bad;
...
80100cb7:	74 19                	je     80100cd2 <exec+0x332>
80100cb9:	8b 4d 08             	mov    0x8(%ebp),%ecx
80100cbc:	83 c0 01             	add    $0x1,%eax
    if(*s == '/')
      last = s+1;
80100cbf:	80 fa 2f             	cmp    $0x2f,%dl
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
    goto bad;
  ...
  // Save program name for debugging.
  for(last=s=path; *s; s++)
80100cc2:	0f b6 10             	movzbl (%eax),%edx
    if(*s == '/')
      last = s+1;
80100cc5:	0f 44 c8             	cmove  %eax,%ecx
...
80100ccd:	75 f0                	jne    80100cbf <exec+0x31f>
80100ccf:	89 4d 08             	mov    %ecx,0x8(%ebp)
    if(*s == '/')
      last = s+1;
  safestrcpy(curproc->name, last, sizeof(curproc->name));
80100cd2:	8b 45 08             	mov    0x8(%ebp),%eax
80100cd5:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80100cdc:	00 
80100cdd:	89 44 24 04          	mov    %eax,0x4(%esp)
80100ce1:	8d 46 6c             	lea    0x6c(%esi),%eax
80100ce4:	89 04 24             	mov    %eax,(%esp)
80100ce7:	e8 74 37 00 00       	call   80104460 <safestrcpy>
...
80100cec:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  ...
  // Commit to the user image.
  oldpgdir = curproc->pgdir;
80100cf2:	8b 7e 04             	mov    0x4(%esi),%edi
  curproc->pgdir = pgdir;
  curproc->sz = STACKTOP-PGSIZE;
80100cf5:	c7 06 fc ef ff 7f    	movl   $0x7fffeffc,(%esi)
      last = s+1;
  safestrcpy(curproc->name, last, sizeof(curproc->name));
  ...
  oldpgdir = curproc->pgdir;
  curproc->pgdir = pgdir;
80100cfb:	89 46 04             	mov    %eax,0x4(%esi)
  curproc->sz = STACKTOP-PGSIZE;
  curproc->tf->eip = elf.entry;  // main
80100cfe:	8b 46 18             	mov    0x18(%esi),%eax
80100d01:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d07:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d0a:	8b 46 18             	mov    0x18(%esi),%eax
80100d0d:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d10:	89 34 24             	mov    %esi,(%esp)
80100d13:	e8 98 59 00 00       	call   801066b0 <switchuvm>
  freevm(oldpgdir);
80100d18:	89 3c 24             	mov    %edi,(%esp)
80100d1b:	e8 10 5d 00 00       	call   80106a30 <freevm>
  return 0;
80100d20:	31 c0                	xor    %eax,%eax
80100d22:	e9 ee fc ff ff       	jmp    80100a15 <exec+0x75>
  // Make the first inaccessible.  Use the second as the user stack.
  sz = PGROUNDUP(sz);
  if( (allocuvm(pgdir, STACKTOP, STACKTOP-(PGSIZE*2))) == 0)
    goto bad;
  clearpteu(pgdir, (char*)(STACKTOP-(PGSIZE*2))); //clear pte of first page to create buffer
  sp = STACKTOP;
80100d27:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
...
80100d34:	e9 23 ff ff ff       	jmp    80100c5c <exec+0x2bc>
...
80100ec7:	e9 b4 1c 00 00       	jmp    80102b80 <end_op>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100ecc:	c7 04 24 3c 6f 10 80 	movl   $0x80106f3c,(%esp)
...
80100fb5:	eb d8                	jmp    80100f8f <fileread+0x5f>
  ...
  panic("fileread");
80100fb7:	c7 04 24 46 6f 10 80 	movl   $0x80106f46,(%esp)
...
801010cc:	e9 1f 22 00 00       	jmp    801032f0 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
801010d1:	c7 04 24 4f 6f 10 80 	movl   $0x80106f4f,(%esp)
801010d8:	e8 83 f2 ff ff       	call   80100360 <panic>
  ...
  panic("filewrite");
801010dd:	c7 04 24 55 6f 10 80 	movl   $0x80106f55,(%esp)
...
80101195:	c7 04 24 5f 6f 10 80 	movl   $0x80106f5f,(%esp)
...
801012bc:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801012bd:	c7 04 24 75 6f 10 80 	movl   $0x80106f75,(%esp)
...
80101375:	eb 93                	jmp    8010130a <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101377:	c7 04 24 85 6f 10 80 	movl   $0x80106f85,(%esp)
...
80101458:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101459:	c7 04 24 98 6f 10 80 	movl   $0x80106f98,(%esp)
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ef1:	c7 04 24 a6 76 10 80 	movl   $0x801076a6,(%esp)
...
80102e3a:	e8 b1 2a 00 00       	call   801058f0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  shminit();       // shared memory
80102e45:	e8 c6 3f 00 00       	call   80106e10 <shminit>
  tvinit();        // trap vectors
80102e4a:	e8 e1 26 00 00       	call   80105530 <tvinit>
80102e4f:	90                   	nop
  binit();         // buffer cache
...
80103117:	0f 85 c5 fe ff ff    	jne    80102fe2 <mpinit+0x52>
  ...
  if((conf = mpconfig(&mp)) == 0)
    panic("Expect to run on an SMP");
8010311d:	c7 04 24 a2 73 10 80 	movl   $0x801073a2,(%esp)
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 25 55 10 80 	movl   $0x80105525,0x14(%eax)
...
801035e6:	c7 44 24 04 f5 73 10 	movl   $0x801073f5,0x4(%esp)
801035ed:	80 
...
80103658:	eb ea                	jmp    80103644 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
8010365a:	c7 04 24 fc 73 10 80 	movl   $0x801073fc,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103666:	c7 04 24 d8 74 10 80 	movl   $0x801074d8,(%esp)
...
80103782:	00 
80103783:	c7 44 24 04 25 74 10 	movl   $0x80107425,0x4(%esp)
8010378a:	80 
8010378b:	89 04 24             	mov    %eax,(%esp)
8010378e:	e8 cd 0c 00 00       	call   80104460 <safestrcpy>
  p->cwd = namei("/");
80103793:	c7 04 24 2e 74 10 80 	movl   $0x8010742e,(%esp)
...
801037c6:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037c7:	c7 04 24 0c 74 10 80 	movl   $0x8010740c,(%esp)
...
8010386c:	0f 84 bc 00 00 00    	je     8010392e <fork+0xde>
  ...
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz+4)) == 0){
80103872:	8b 03                	mov    (%ebx),%eax
80103874:	83 c0 04             	add    $0x4,%eax
80103877:	89 44 24 04          	mov    %eax,0x4(%esp)
8010387b:	8b 43 04             	mov    0x4(%ebx),%eax
8010387e:	89 04 24             	mov    %eax,(%esp)
80103881:	e8 0a 33 00 00       	call   80106b90 <copyuvm>
80103886:	85 c0                	test   %eax,%eax
80103888:	89 47 04             	mov    %eax,0x4(%edi)
8010388b:	0f 84 a4 00 00 00    	je     80103935 <fork+0xe5>
    kfree(np->kstack);
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
...
80103893:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103896:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
  *np->tf = *curproc->tf;
80103898:	8b 79 18             	mov    0x18(%ecx),%edi
8010389b:	89 c8                	mov    %ecx,%eax
  ...
  np->sz = curproc->sz;
  np->parent = curproc;
8010389d:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
...
801038aa:	31 f6                	xor    %esi,%esi
  ...
  *np->tf = *curproc->tf;
  ...
  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
801038ac:	8b 40 18             	mov    0x18(%eax),%eax
...
80103a6d:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103a6e:	c7 04 24 30 74 10 80 	movl   $0x80107430,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103a7a:	c7 04 24 5c 74 10 80 	movl   $0x8010745c,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103a86:	c7 04 24 4e 74 10 80 	movl   $0x8010744e,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103a92:	c7 04 24 42 74 10 80 	movl   $0x80107442,(%esp)
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 7d 74 10 80 	movl   $0x8010747d,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103ba7:	c7 04 24 70 74 10 80 	movl   $0x80107470,(%esp)
...
80103c8e:	c7 04 24 8f 74 10 80 	movl   $0x8010748f,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103c9a:	c7 04 24 89 74 10 80 	movl   $0x80107489,(%esp)
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 8b 75 10 80 	movl   $0x8010758b,(%esp)
...
80103eaa:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103ead:	ba a0 74 10 80       	mov    $0x801074a0,%edx
  uint pc[10];
...
80103eb4:	8b 14 85 00 75 10 80 	mov    -0x7fef8b00(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103ebb:	b8 a0 74 10 80       	mov    $0x801074a0,%eax
...
80103ed0:	c7 04 24 a4 74 10 80 	movl   $0x801074a4,(%esp)
...
80103f19:	c7 04 24 e1 6e 10 80 	movl   $0x80106ee1,(%esp)
...
80103f4a:	c7 44 24 04 18 75 10 	movl   $0x80107518,0x4(%esp)
80103f51:	80 
...
801041a7:	eb ac                	jmp    80104155 <acquire+0x15>
    panic("acquire");
801041a9:	c7 04 24 23 75 10 80 	movl   $0x80107523,(%esp)
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010420a:	c7 04 24 42 75 10 80 	movl   $0x80107542,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104216:	c7 04 24 2b 75 10 80 	movl   $0x8010752b,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104241:	c7 04 24 49 75 10 80 	movl   $0x80107549,(%esp)
...
801044da:	c7 04 24 51 75 10 80 	movl   $0x80107551,(%esp)
801044e1:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801044e5:	e8 66 c1 ff ff       	call   80100650 <cprintf>
801044ea:	c7 04 24 54 75 10 80 	movl   $0x80107554,(%esp)
801044f1:	e8 5a c1 ff ff       	call   80100650 <cprintf>
  if(addr <= (STACKTOP-PGSIZE) || addr+4 > STACKTOP){
801044f6:	8d 43 04             	lea    0x4(%ebx),%eax
801044f9:	3d fc ff ff 7f       	cmp    $0x7ffffffc,%eax
801044fe:	77 28                	ja     80104528 <fetchint+0x58>
80104500:	81 fb fc ef ff 7f    	cmp    $0x7fffeffc,%ebx
80104506:	76 20                	jbe    80104528 <fetchint+0x58>
...
8010450f:	c7 04 24 72 75 10 80 	movl   $0x80107572,(%esp)
80104516:	e8 35 c1 ff ff       	call   80100650 <cprintf>
  return 0;
...
cprintf("%d",addr); cprintf(" :fetchint \n");
  if(addr <= (STACKTOP-PGSIZE) || addr+4 > STACKTOP){
    cprintf("fetch int error\n");
80104528:	c7 04 24 61 75 10 80 	movl   $0x80107561,(%esp)
8010452f:	e8 1c c1 ff ff       	call   80100650 <cprintf>
    return -1;}
80104534:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104539:	eb e2                	jmp    8010451d <fetchint+0x4d>
8010453b:	90                   	nop
...
8010454b:	c7 04 24 51 75 10 80 	movl   $0x80107551,(%esp)
// Fetch the nul-terminated string at addr from the current process.
// Doesn't actually copy the string - just sets *pp to point at it.
// Returns length of string, not including nul.
int
fetchstr(uint addr, char **pp)
{
80104552:	8b 75 0c             	mov    0xc(%ebp),%esi
  char *s, *ep;
//  struct proc *curproc = myproc();
cprintf("%d",addr); cprintf(":fetchstr \n");
80104555:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104559:	e8 f2 c0 ff ff       	call   80100650 <cprintf>
8010455e:	c7 04 24 81 75 10 80 	movl   $0x80107581,(%esp)
80104565:	e8 e6 c0 ff ff       	call   80100650 <cprintf>
  if(addr > STACKTOP){ cprintf("fetch str error\n");
8010456a:	81 fb fc ff ff 7f    	cmp    $0x7ffffffc,%ebx
80104570:	77 4e                	ja     801045c0 <fetchstr+0x80>
    return -1;}
  *pp = (char*)addr;
  ep = (char*)STACKTOP;
  for(s = *pp; s < ep; s++){
80104572:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
  char *s, *ep;
//  struct proc *curproc = myproc();
cprintf("%d",addr); cprintf(":fetchstr \n");
  if(addr > STACKTOP){ cprintf("fetch str error\n");
    return -1;}
  *pp = (char*)addr;
80104578:	89 1e                	mov    %ebx,(%esi)
  ep = (char*)STACKTOP;
  for(s = *pp; s < ep; s++){
8010457a:	76 0f                	jbe    8010458b <fetchstr+0x4b>
8010457c:	eb 2a                	jmp    801045a8 <fetchstr+0x68>
8010457e:	66 90                	xchg   %ax,%ax
80104580:	83 c3 01             	add    $0x1,%ebx
80104583:	81 fb fc ff ff 7f    	cmp    $0x7ffffffc,%ebx
80104589:	74 1d                	je     801045a8 <fetchstr+0x68>
    if(*s == 0){
8010458b:	80 3b 00             	cmpb   $0x0,(%ebx)
8010458e:	75 f0                	jne    80104580 <fetchstr+0x40>
cprintf("fetchstr good\n");
80104590:	c7 04 24 9e 75 10 80 	movl   $0x8010759e,(%esp)
80104597:	e8 b4 c0 ff ff       	call   80100650 <cprintf>
      return s - *pp;}
8010459c:	89 d8                	mov    %ebx,%eax
8010459e:	2b 06                	sub    (%esi),%eax
  }
...
cprintf("fetchstr: end loop, fail\n");
801045a8:	c7 04 24 ad 75 10 80 	movl   $0x801075ad,(%esp)
...
cprintf("%d",addr); cprintf(":fetchstr \n");
  if(addr > STACKTOP){ cprintf("fetch str error\n");
801045c0:	c7 04 24 8d 75 10 80 	movl   $0x8010758d,(%esp)
801045c7:	e8 84 c0 ff ff       	call   80100650 <cprintf>
    return -1;}
801045cc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045d1:	eb e6                	jmp    801045b9 <fetchstr+0x79>
...
801045e8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  cprintf("from argint\n");
801045eb:	c7 04 24 c7 75 10 80 	movl   $0x801075c7,(%esp)
}
...
argint(int n, int *ip)
{
801045f2:	8b 75 0c             	mov    0xc(%ebp),%esi
  cprintf("from argint\n");
801045f5:	e8 56 c0 ff ff       	call   80100650 <cprintf>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801045fa:	e8 a1 f0 ff ff       	call   801036a0 <myproc>
801045ff:	89 75 0c             	mov    %esi,0xc(%ebp)
80104602:	8b 40 18             	mov    0x18(%eax),%eax
80104605:	8b 40 44             	mov    0x44(%eax),%eax
80104608:	8d 44 98 04          	lea    0x4(%eax,%ebx,4),%eax
8010460c:	89 45 08             	mov    %eax,0x8(%ebp)
}
...
argint(int n, int *ip)
{
  cprintf("from argint\n");
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104615:	e9 b6 fe ff ff       	jmp    801044d0 <fetchint>
...
80104624:	83 ec 24             	sub    $0x24,%esp
80104627:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
//  struct proc *curproc = myproc();
 
  if(argint(n, &i) < 0)
8010462a:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010462d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104631:	8b 45 08             	mov    0x8(%ebp),%eax
80104634:	89 04 24             	mov    %eax,(%esp)
80104637:	e8 a4 ff ff ff       	call   801045e0 <argint>
8010463c:	85 c0                	test   %eax,%eax
8010463e:	78 50                	js     80104690 <argptr+0x70>
    return -1;
  if(size > PGSIZE || (uint)i < STACKTOP-PGSIZE || (uint)i+size >= STACKTOP){ cprintf("argprt error\n");
80104640:	81 fb 00 10 00 00    	cmp    $0x1000,%ebx
80104646:	7f 30                	jg     80104678 <argptr+0x58>
80104648:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010464b:	3d fb ef ff 7f       	cmp    $0x7fffeffb,%eax
80104650:	76 26                	jbe    80104678 <argptr+0x58>
80104652:	01 c3                	add    %eax,%ebx
80104654:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
8010465a:	77 1c                	ja     80104678 <argptr+0x58>
    return -1;}
  *pp = (char*)i;
8010465c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010465f:	89 02                	mov    %eax,(%edx)

cprintf("argptr good\n");
80104661:	c7 04 24 e2 75 10 80 	movl   $0x801075e2,(%esp)
80104668:	e8 e3 bf ff ff       	call   80100650 <cprintf>
  return 0;
8010466d:	31 c0                	xor    %eax,%eax
}
8010466f:	83 c4 24             	add    $0x24,%esp
80104672:	5b                   	pop    %ebx
80104673:	5d                   	pop    %ebp
80104674:	c3                   	ret    
...
//  struct proc *curproc = myproc();
  ...
  if(argint(n, &i) < 0)
    return -1;
  if(size > PGSIZE || (uint)i < STACKTOP-PGSIZE || (uint)i+size >= STACKTOP){ cprintf("argprt error\n");
80104678:	c7 04 24 d4 75 10 80 	movl   $0x801075d4,(%esp)
8010467f:	e8 cc bf ff ff       	call   80100650 <cprintf>
    return -1;}
  *pp = (char*)i;
...
80104684:	83 c4 24             	add    $0x24,%esp
//  struct proc *curproc = myproc();
...
80104695:	eb d8                	jmp    8010466f <argptr+0x4f>
...
801046b3:	e8 28 ff ff ff       	call   801045e0 <argint>
801046b8:	85 c0                	test   %eax,%eax
801046ba:	78 14                	js     801046d0 <argstr+0x30>
    return -1;
  }
  return fetchstr(addr, pp);
801046bc:	8b 45 0c             	mov    0xc(%ebp),%eax
801046bf:	89 44 24 04          	mov    %eax,0x4(%esp)
801046c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046c6:	89 04 24             	mov    %eax,(%esp)
801046c9:	e8 72 fe ff ff       	call   80104540 <fetchstr>
}
801046ce:	c9                   	leave  
801046cf:	c3                   	ret    
// between this check and being used by the kernel.)
...
801046d3:	c7 04 24 51 75 10 80 	movl   $0x80107551,(%esp)
801046da:	89 44 24 04          	mov    %eax,0x4(%esp)
801046de:	e8 6d bf ff ff       	call   80100650 <cprintf>
801046e3:	c7 04 24 81 75 10 80 	movl   $0x80107581,(%esp)
801046ea:	e8 61 bf ff ff       	call   80100650 <cprintf>
801046ef:	c7 04 24 ef 75 10 80 	movl   $0x801075ef,(%esp)
801046f6:	e8 55 bf ff ff       	call   80100650 <cprintf>
    return -1;
...
80104715:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104718:	e8 83 ef ff ff       	call   801036a0 <myproc>
...
80104728:	83 fa 16             	cmp    $0x16,%edx
8010472b:	77 1b                	ja     80104748 <syscall+0x38>
8010472d:	8b 14 85 20 76 10 80 	mov    -0x7fef89e0(,%eax,4),%edx
80104734:	85 d2                	test   %edx,%edx
80104736:	74 10                	je     80104748 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104738:	ff d2                	call   *%edx
8010473a:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
8010474f:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80104753:	8b 43 10             	mov    0x10(%ebx),%eax
80104756:	c7 04 24 fd 75 10 80 	movl   $0x801075fd,(%esp)
8010475d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104761:	e8 ea be ff ff       	call   80100650 <cprintf>
            curproc->pid, curproc->name, num);
    curproc->tf->eax = -1;
80104766:	8b 43 18             	mov    0x18(%ebx),%eax
80104769:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80104786:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104789:	e8 12 ef ff ff       	call   801036a0 <myproc>
...
801048e0:	c7 44 24 04 9c 76 10 	movl   $0x8010769c,0x4(%esp)
801048e7:	80 
...
801048fb:	c7 44 24 04 9b 76 10 	movl   $0x8010769b,0x4(%esp)
80104902:	80 
...
80104911:	79 89                	jns    8010489c <create+0xdc>
      panic("create dots");
80104913:	c7 04 24 8f 76 10 80 	movl   $0x8010768f,(%esp)
8010491a:	e8 41 ba ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010491f:	c7 04 24 9e 76 10 80 	movl   $0x8010769e,(%esp)
80104926:	e8 35 ba ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010492b:	c7 04 24 80 76 10 80 	movl   $0x80107680,(%esp)
...
8010495a:	e8 81 fc ff ff       	call   801045e0 <argint>
...
80104969:	e8 32 ed ff ff       	call   801036a0 <myproc>
...
801049d9:	e8 f2 c3 ff ff       	call   80100dd0 <filedup>
  return fd;
...
80104a12:	e8 c9 fb ff ff       	call   801045e0 <argint>
...
80104a30:	e8 eb fb ff ff       	call   80104620 <argptr>
...
80104a82:	e8 59 fb ff ff       	call   801045e0 <argint>
...
80104aa0:	e8 7b fb ff ff       	call   80104620 <argptr>
...
80104ae3:	78 23                	js     80104b08 <sys_close+0x38>
    return -1;
  myproc()->ofile[fd] = 0;
80104ae5:	e8 b6 eb ff ff       	call   801036a0 <myproc>
...
80104afb:	e8 20 c3 ff ff       	call   80100e20 <fileclose>
  return 0;
...
80104b3a:	e8 e1 fa ff ff       	call   80104620 <argptr>
...
80104b77:	e8 24 fb ff ff       	call   801046a0 <argstr>
...
80104b92:	e8 09 fb ff ff       	call   801046a0 <argstr>
80104b97:	85 c0                	test   %eax,%eax
80104b99:	0f 88 cb 00 00 00    	js     80104c6a <sys_link+0x10a>
    return -1;

  begin_op();
80104b9f:	e8 6c df ff ff       	call   80102b10 <begin_op>
  if((ip = namei(old)) == 0){
...
80104c29:	e8 a2 cb ff ff       	call   801017d0 <iput>
  ...
  end_op();
80104c2e:	e8 4d df ff ff       	call   80102b80 <end_op>
  ip->nlink--;
  iupdate(ip);
  iunlockput(ip);
  end_op();
...
80104c97:	e8 04 fa ff ff       	call   801046a0 <argstr>
80104c9c:	85 c0                	test   %eax,%eax
80104c9e:	0f 88 76 01 00 00    	js     80104e1a <sys_unlink+0x19a>
    return -1;

  begin_op();
80104ca4:	e8 67 de ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104cd1:	c7 44 24 04 9c 76 10 	movl   $0x8010769c,0x4(%esp)
80104cd8:	80 
...
80104ce9:	c7 44 24 04 9b 76 10 	movl   $0x8010769b,0x4(%esp)
80104cf0:	80 
...
80104d4e:	e8 2d f5 ff ff       	call   80104280 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104e38:	e9 48 ff ff ff       	jmp    80104d85 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104e3d:	c7 04 24 c0 76 10 80 	movl   $0x801076c0,(%esp)
80104e44:	e8 17 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104e49:	c7 04 24 d2 76 10 80 	movl   $0x801076d2,(%esp)
80104e50:	e8 0b b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104e55:	c7 04 24 ae 76 10 80 	movl   $0x801076ae,(%esp)
...
80104e87:	e8 14 f8 ff ff       	call   801046a0 <argstr>
...
80104ea2:	e8 39 f7 ff ff       	call   801045e0 <argint>
80104ea7:	85 c0                	test   %eax,%eax
80104ea9:	0f 88 b6 00 00 00    	js     80104f65 <sys_open+0xf5>
    return -1;

  begin_op();
80104eaf:	e8 5c dc ff ff       	call   80102b10 <begin_op>
...
80104ee6:	e8 75 be ff ff       	call   80100d60 <filealloc>
...
80104f07:	e8 84 c8 ff ff       	call   80101790 <iunlock>
  end_op();
80104f0c:	e8 6f dc ff ff       	call   80102b80 <end_op>
...
80104f9b:	e8 80 be ff ff       	call   80100e20 <fileclose>
...
80105029:	e8 72 f6 ff ff       	call   801046a0 <argstr>
...
80105040:	e8 9b f5 ff ff       	call   801045e0 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
80105057:	e8 84 f5 ff ff       	call   801045e0 <argint>
  char *path;
  int major, minor;
...
8010507f:	e8 8c c8 ff ff       	call   80101910 <iunlockput>
  end_op();
80105084:	e8 f7 da ff ff       	call   80102b80 <end_op>
  return 0;
...
8010508d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if((argstr(0, &path)) < 0 ||
     ...
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80105090:	e8 eb da ff ff       	call   80102b80 <end_op>
    return -1;
...
801050f9:	e8 d2 c6 ff ff       	call   801017d0 <iput>
  end_op();
801050fe:	e8 7d da ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
...
80105110:	e8 fb c7 ff ff       	call   80101910 <iunlockput>
    end_op();
80105115:	e8 66 da ff ff       	call   80102b80 <end_op>
  iunlock(ip);
  iput(curproc->cwd);
  end_op();
  curproc->cwd = ip;
...
8010514d:	e8 4e f5 ff ff       	call   801046a0 <argstr>
...
8010516b:	e8 70 f4 ff ff       	call   801045e0 <argint>
...
8010519b:	e8 e0 f0 ff ff       	call   80104280 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
...
801051b0:	e8 1b f3 ff ff       	call   801044d0 <fetchint>
...
801051ca:	e8 71 f3 ff ff       	call   80104540 <fetchstr>
...
8010523d:	e8 de f3 ff ff       	call   80104620 <argptr>
...
80105253:	e8 18 df ff ff       	call   80103170 <pipealloc>
...
801052a3:	e8 78 bb ff ff       	call   80100e20 <fileclose>
    fileclose(wf);
801052a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052ab:	89 04 24             	mov    %eax,(%esp)
801052ae:	e8 6d bb ff ff       	call   80100e20 <fileclose>
    return -1;
  }
  fd[0] = fd0;
  fd[1] = fd1;
...
801052d4:	e8 07 f3 ff ff       	call   801045e0 <argint>
801052d9:	85 c0                	test   %eax,%eax
801052db:	78 33                	js     80105310 <sys_shm_open+0x50>
    return -1;

  if(argptr(1, (char **) (&pointer),4)<0)
801052dd:	8d 45 f4             	lea    -0xc(%ebp),%eax
801052e0:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801052e7:	00 
801052e8:	89 44 24 04          	mov    %eax,0x4(%esp)
801052ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801052f3:	e8 28 f3 ff ff       	call   80104620 <argptr>
801052f8:	85 c0                	test   %eax,%eax
801052fa:	78 14                	js     80105310 <sys_shm_open+0x50>
    return -1;
  return shm_open(id, pointer);
801052fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80105303:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105306:	89 04 24             	mov    %eax,(%esp)
80105309:	e8 62 1b 00 00       	call   80106e70 <shm_open>
}
8010530e:	c9                   	leave  
8010530f:	c3                   	ret    
int sys_shm_open(void) {
...
80105334:	e8 a7 f2 ff ff       	call   801045e0 <argint>
80105339:	85 c0                	test   %eax,%eax
8010533b:	78 13                	js     80105350 <sys_shm_close+0x30>
    return -1;
...
80105343:	e8 38 1b 00 00       	call   80106e80 <shm_close>
}
80105348:	c9                   	leave  
80105349:	c3                   	ret    
...
{
  return fork();
80105364:	e9 e7 e4 ff ff       	jmp    80103850 <fork>
...
80105373:	83 ec 08             	sub    $0x8,%esp
  exit();
80105376:	e8 25 e7 ff ff       	call   80103aa0 <exit>
...
{
  return wait();
80105384:	e9 27 e9 ff ff       	jmp    80103cb0 <wait>
...
801053a4:	e8 37 f2 ff ff       	call   801045e0 <argint>
801053a9:	85 c0                	test   %eax,%eax
801053ab:	78 13                	js     801053c0 <sys_kill+0x30>
    return -1;
  return kill(pid);
801053ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053b0:	89 04 24             	mov    %eax,(%esp)
801053b3:	e8 38 ea ff ff       	call   80103df0 <kill>
}
801053b8:	c9                   	leave  
801053b9:	c3                   	ret    
...
801053d3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801053d6:	e8 c5 e2 ff ff       	call   801036a0 <myproc>
...
801053f5:	e8 e6 f1 ff ff       	call   801045e0 <argint>
801053fa:	85 c0                	test   %eax,%eax
801053fc:	78 22                	js     80105420 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801053fe:	e8 9d e2 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
80105403:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = myproc()->sz;
80105406:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105408:	89 14 24             	mov    %edx,(%esp)
8010540b:	e8 d0 e3 ff ff       	call   801037e0 <growproc>
80105410:	85 c0                	test   %eax,%eax
80105412:	78 0c                	js     80105420 <sys_sbrk+0x40>
    return -1;
  return addr;
...
80105425:	eb ef                	jmp    80105416 <sys_sbrk+0x36>
...
80105445:	e8 96 f1 ff ff       	call   801045e0 <argint>
8010544a:	85 c0                	test   %eax,%eax
8010544c:	78 7e                	js     801054cc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010544e:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105455:	e8 e6 ec ff ff       	call   80104140 <acquire>
  ticks0 = ticks;
...
8010545a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
8010545d:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
80105463:	85 d2                	test   %edx,%edx
80105465:	75 29                	jne    80105490 <sys_sleep+0x60>
80105467:	eb 4f                	jmp    801054b8 <sys_sleep+0x88>
...
80105470:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
80105477:	80 
80105478:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
8010547f:	e8 7c e7 ff ff       	call   80103c00 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105484:	a1 a0 55 11 80       	mov    0x801155a0,%eax
80105489:	29 d8                	sub    %ebx,%eax
8010548b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010548e:	73 28                	jae    801054b8 <sys_sleep+0x88>
    if(myproc()->killed){
80105490:	e8 0b e2 ff ff       	call   801036a0 <myproc>
80105495:	8b 40 24             	mov    0x24(%eax),%eax
80105498:	85 c0                	test   %eax,%eax
8010549a:	74 d4                	je     80105470 <sys_sleep+0x40>
      release(&tickslock);
8010549c:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801054a3:	e8 88 ed ff ff       	call   80104230 <release>
      return -1;
...
801054ad:	83 c4 24             	add    $0x24,%esp
801054b0:	5b                   	pop    %ebx
801054b1:	5d                   	pop    %ebp
801054b2:	c3                   	ret    
801054b3:	90                   	nop
801054b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
801054b8:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801054bf:	e8 6c ed ff ff       	call   80104230 <release>
  return 0;
}
801054c4:	83 c4 24             	add    $0x24,%esp
      return -1;
    }
    sleep(&ticks, &tickslock);
  }
...
801054d1:	eb da                	jmp    801054ad <sys_sleep+0x7d>
...
801054e4:	83 ec 14             	sub    $0x14,%esp
  uint xticks;

  acquire(&tickslock);
801054e7:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801054ee:	e8 4d ec ff ff       	call   80104140 <acquire>
  xticks = ticks;
801054f3:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
801054f9:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105500:	e8 2b ed ff ff       	call   80104230 <release>
  return xticks;
}
80105505:	83 c4 14             	add    $0x14,%esp
...
8010550e:	06                   	push   %es
  pushl %fs
8010550f:	0f a0                	push   %fs
  pushl %gs
80105511:	0f a8                	push   %gs
  pushal
80105513:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105514:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105518:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010551a:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010551c:	54                   	push   %esp
  call trap
8010551d:	e8 de 00 00 00       	call   80105600 <trap>
  addl $4, %esp
80105522:	83 c4 04             	add    $0x4,%esp
...
80105525:	61                   	popa   
  popl %gs
80105526:	0f a9                	pop    %gs
  popl %fs
80105528:	0f a1                	pop    %fs
  popl %es
8010552a:	07                   	pop    %es
  popl %ds
8010552b:	1f                   	pop    %ds
...
80105544:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
8010554b:	80 
8010554c:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
80105553:	00 
80105554:	c6 04 c5 a5 4d 11 80 	movb   $0x8e,-0x7feeb25b(,%eax,8)
8010555b:	8e 
8010555c:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105563:	80 
80105564:	c1 ea 10             	shr    $0x10,%edx
80105567:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
8010556e:	80 
void
tvinit(void)
{
...
80105589:	c7 44 24 04 e1 76 10 	movl   $0x801076e1,0x4(%esp)
80105590:	80 
80105591:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105598:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
8010559f:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801055a5:	c1 e8 10             	shr    $0x10,%eax
801055a8:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
801055af:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
801055b6:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6

  initlock(&tickslock, "time");
801055bc:	e8 8f ea ff ff       	call   80104050 <initlock>
}
801055c1:	c9                   	leave  
801055c2:	c3                   	ret    
...
801055db:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801055df:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
80105620:	ff 24 85 88 77 10 80 	jmp    *-0x7fef8878(,%eax,4)
80105627:	90                   	nop
    lapiceoi();
    break;
...
80105628:	e8 73 e0 ff ff       	call   801036a0 <myproc>
...
8010564c:	e8 2f e0 ff ff       	call   80103680 <cpuid>
...
8010565c:	e8 3f e0 ff ff       	call   801036a0 <myproc>
...
80105693:	c7 04 24 44 77 10 80 	movl   $0x80107744,(%esp)
...
801056c5:	e8 d6 df ff ff       	call   801036a0 <myproc>
...
801056d9:	74 4d                	je     80105728 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801056db:	e8 c0 df ff ff       	call   801036a0 <myproc>
...
8010571b:	75 a8                	jne    801056c5 <trap+0xc5>
    exit();
8010571d:	e8 7e e3 ff ff       	call   80103aa0 <exit>
...
80105730:	75 a9                	jne    801056db <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105732:	e8 89 e4 ff ff       	call   80103bc0 <yield>
...
80105739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105740:	e8 3b df ff ff       	call   80103680 <cpuid>
...
8010574d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105750:	e8 2b d0 ff ff       	call   80102780 <lapiceoi>
    break;
...
8010575a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105760:	e8 6b ce ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
80105765:	e8 16 d0 ff ff       	call   80102780 <lapiceoi>
    break;
...
80105787:	e8 f4 de ff ff       	call   80103680 <cpuid>
8010578c:	c7 04 24 ec 76 10 80 	movl   $0x801076ec,(%esp)
...
8010579f:	e8 ac ae ff ff       	call   80100650 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
801057a4:	e8 d7 cf ff ff       	call   80102780 <lapiceoi>
    break;
...
801057ae:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801057b0:	e8 cb c8 ff ff       	call   80102080 <ideintr>
...
801057ef:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801057f0:	e9 ab e2 ff ff       	jmp    80103aa0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801057f8:	e8 a3 e2 ff ff       	call   80103aa0 <exit>
...
801057ff:	90                   	nop
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
80105800:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105807:	e8 34 e9 ff ff       	call   80104140 <acquire>
      ticks++;
      wakeup(&ticks);
8010580c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105813:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010581a:	e8 71 e5 ff ff       	call   80103d90 <wakeup>
      release(&tickslock);
8010581f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105826:	e8 05 ea ff ff       	call   80104230 <release>
...
80105836:	e8 45 de ff ff       	call   80103680 <cpuid>
...
8010584a:	c7 04 24 10 77 10 80 	movl   $0x80107710,(%esp)
80105851:	89 44 24 04          	mov    %eax,0x4(%esp)
80105855:	e8 f6 ad ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010585a:	c7 04 24 e6 76 10 80 	movl   $0x801076e6,(%esp)
...
801058c7:	e8 d4 ce ff ff       	call   801027a0 <microdelay>
{
  int i;
...
80105957:	00 
  ...
  for(p="xv6...\n"; *p; p++)
80105958:	bb 08 78 10 80       	mov    $0x80107808,%ebx
...
80105964:	e8 47 c9 ff ff       	call   801022b0 <ioapicenable>
...
801059a6:	6a 00                	push   $0x0
  jmp alltraps
801059a8:	e9 60 fb ff ff       	jmp    8010550d <alltraps>
...
801059af:	6a 01                	push   $0x1
  jmp alltraps
801059b1:	e9 57 fb ff ff       	jmp    8010550d <alltraps>
...
801059b8:	6a 02                	push   $0x2
  jmp alltraps
801059ba:	e9 4e fb ff ff       	jmp    8010550d <alltraps>
...
801059c1:	6a 03                	push   $0x3
  jmp alltraps
801059c3:	e9 45 fb ff ff       	jmp    8010550d <alltraps>
...
801059ca:	6a 04                	push   $0x4
  jmp alltraps
801059cc:	e9 3c fb ff ff       	jmp    8010550d <alltraps>
...
801059d3:	6a 05                	push   $0x5
  jmp alltraps
801059d5:	e9 33 fb ff ff       	jmp    8010550d <alltraps>
...
801059dc:	6a 06                	push   $0x6
  jmp alltraps
801059de:	e9 2a fb ff ff       	jmp    8010550d <alltraps>
...
801059e5:	6a 07                	push   $0x7
  jmp alltraps
801059e7:	e9 21 fb ff ff       	jmp    8010550d <alltraps>
...
801059ec:	6a 08                	push   $0x8
  jmp alltraps
801059ee:	e9 1a fb ff ff       	jmp    8010550d <alltraps>
...
801059f5:	6a 09                	push   $0x9
  jmp alltraps
801059f7:	e9 11 fb ff ff       	jmp    8010550d <alltraps>
...
801059fc:	6a 0a                	push   $0xa
  jmp alltraps
801059fe:	e9 0a fb ff ff       	jmp    8010550d <alltraps>
...
80105a03:	6a 0b                	push   $0xb
  jmp alltraps
80105a05:	e9 03 fb ff ff       	jmp    8010550d <alltraps>
...
80105a0a:	6a 0c                	push   $0xc
  jmp alltraps
80105a0c:	e9 fc fa ff ff       	jmp    8010550d <alltraps>
...
80105a11:	6a 0d                	push   $0xd
  jmp alltraps
80105a13:	e9 f5 fa ff ff       	jmp    8010550d <alltraps>
...
80105a18:	6a 0e                	push   $0xe
  jmp alltraps
80105a1a:	e9 ee fa ff ff       	jmp    8010550d <alltraps>
...
80105a21:	6a 0f                	push   $0xf
  jmp alltraps
80105a23:	e9 e5 fa ff ff       	jmp    8010550d <alltraps>
...
80105a2a:	6a 10                	push   $0x10
  jmp alltraps
80105a2c:	e9 dc fa ff ff       	jmp    8010550d <alltraps>
...
80105a31:	6a 11                	push   $0x11
  jmp alltraps
80105a33:	e9 d5 fa ff ff       	jmp    8010550d <alltraps>
...
80105a3a:	6a 12                	push   $0x12
  jmp alltraps
80105a3c:	e9 cc fa ff ff       	jmp    8010550d <alltraps>
...
80105a43:	6a 13                	push   $0x13
  jmp alltraps
80105a45:	e9 c3 fa ff ff       	jmp    8010550d <alltraps>
...
80105a4c:	6a 14                	push   $0x14
  jmp alltraps
80105a4e:	e9 ba fa ff ff       	jmp    8010550d <alltraps>
...
80105a55:	6a 15                	push   $0x15
  jmp alltraps
80105a57:	e9 b1 fa ff ff       	jmp    8010550d <alltraps>
...
80105a5e:	6a 16                	push   $0x16
  jmp alltraps
80105a60:	e9 a8 fa ff ff       	jmp    8010550d <alltraps>
...
80105a67:	6a 17                	push   $0x17
  jmp alltraps
80105a69:	e9 9f fa ff ff       	jmp    8010550d <alltraps>
...
80105a70:	6a 18                	push   $0x18
  jmp alltraps
80105a72:	e9 96 fa ff ff       	jmp    8010550d <alltraps>
...
80105a79:	6a 19                	push   $0x19
  jmp alltraps
80105a7b:	e9 8d fa ff ff       	jmp    8010550d <alltraps>
...
80105a82:	6a 1a                	push   $0x1a
  jmp alltraps
80105a84:	e9 84 fa ff ff       	jmp    8010550d <alltraps>
...
80105a8b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a8d:	e9 7b fa ff ff       	jmp    8010550d <alltraps>
...
80105a94:	6a 1c                	push   $0x1c
  jmp alltraps
80105a96:	e9 72 fa ff ff       	jmp    8010550d <alltraps>
...
80105a9d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a9f:	e9 69 fa ff ff       	jmp    8010550d <alltraps>
...
80105aa6:	6a 1e                	push   $0x1e
  jmp alltraps
80105aa8:	e9 60 fa ff ff       	jmp    8010550d <alltraps>
...
80105aaf:	6a 1f                	push   $0x1f
  jmp alltraps
80105ab1:	e9 57 fa ff ff       	jmp    8010550d <alltraps>
...
80105ab8:	6a 20                	push   $0x20
  jmp alltraps
80105aba:	e9 4e fa ff ff       	jmp    8010550d <alltraps>
...
80105ac1:	6a 21                	push   $0x21
  jmp alltraps
80105ac3:	e9 45 fa ff ff       	jmp    8010550d <alltraps>
...
80105aca:	6a 22                	push   $0x22
  jmp alltraps
80105acc:	e9 3c fa ff ff       	jmp    8010550d <alltraps>
...
80105ad3:	6a 23                	push   $0x23
  jmp alltraps
80105ad5:	e9 33 fa ff ff       	jmp    8010550d <alltraps>
...
80105adc:	6a 24                	push   $0x24
  jmp alltraps
80105ade:	e9 2a fa ff ff       	jmp    8010550d <alltraps>
...
80105ae5:	6a 25                	push   $0x25
  jmp alltraps
80105ae7:	e9 21 fa ff ff       	jmp    8010550d <alltraps>
...
80105aee:	6a 26                	push   $0x26
  jmp alltraps
80105af0:	e9 18 fa ff ff       	jmp    8010550d <alltraps>
...
80105af7:	6a 27                	push   $0x27
  jmp alltraps
80105af9:	e9 0f fa ff ff       	jmp    8010550d <alltraps>
...
80105b00:	6a 28                	push   $0x28
  jmp alltraps
80105b02:	e9 06 fa ff ff       	jmp    8010550d <alltraps>
...
80105b09:	6a 29                	push   $0x29
  jmp alltraps
80105b0b:	e9 fd f9 ff ff       	jmp    8010550d <alltraps>
...
80105b12:	6a 2a                	push   $0x2a
  jmp alltraps
80105b14:	e9 f4 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b1b:	6a 2b                	push   $0x2b
  jmp alltraps
80105b1d:	e9 eb f9 ff ff       	jmp    8010550d <alltraps>
...
80105b24:	6a 2c                	push   $0x2c
  jmp alltraps
80105b26:	e9 e2 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b2d:	6a 2d                	push   $0x2d
  jmp alltraps
80105b2f:	e9 d9 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b36:	6a 2e                	push   $0x2e
  jmp alltraps
80105b38:	e9 d0 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b3f:	6a 2f                	push   $0x2f
  jmp alltraps
80105b41:	e9 c7 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b48:	6a 30                	push   $0x30
  jmp alltraps
80105b4a:	e9 be f9 ff ff       	jmp    8010550d <alltraps>
...
80105b51:	6a 31                	push   $0x31
  jmp alltraps
80105b53:	e9 b5 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b5a:	6a 32                	push   $0x32
  jmp alltraps
80105b5c:	e9 ac f9 ff ff       	jmp    8010550d <alltraps>
...
80105b63:	6a 33                	push   $0x33
  jmp alltraps
80105b65:	e9 a3 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b6c:	6a 34                	push   $0x34
  jmp alltraps
80105b6e:	e9 9a f9 ff ff       	jmp    8010550d <alltraps>
...
80105b75:	6a 35                	push   $0x35
  jmp alltraps
80105b77:	e9 91 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b7e:	6a 36                	push   $0x36
  jmp alltraps
80105b80:	e9 88 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b87:	6a 37                	push   $0x37
  jmp alltraps
80105b89:	e9 7f f9 ff ff       	jmp    8010550d <alltraps>
...
80105b90:	6a 38                	push   $0x38
  jmp alltraps
80105b92:	e9 76 f9 ff ff       	jmp    8010550d <alltraps>
...
80105b99:	6a 39                	push   $0x39
  jmp alltraps
80105b9b:	e9 6d f9 ff ff       	jmp    8010550d <alltraps>
...
80105ba2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ba4:	e9 64 f9 ff ff       	jmp    8010550d <alltraps>
...
80105bab:	6a 3b                	push   $0x3b
  jmp alltraps
80105bad:	e9 5b f9 ff ff       	jmp    8010550d <alltraps>
...
80105bb4:	6a 3c                	push   $0x3c
  jmp alltraps
80105bb6:	e9 52 f9 ff ff       	jmp    8010550d <alltraps>
...
80105bbd:	6a 3d                	push   $0x3d
  jmp alltraps
80105bbf:	e9 49 f9 ff ff       	jmp    8010550d <alltraps>
...
80105bc6:	6a 3e                	push   $0x3e
  jmp alltraps
80105bc8:	e9 40 f9 ff ff       	jmp    8010550d <alltraps>
...
80105bcf:	6a 3f                	push   $0x3f
  jmp alltraps
80105bd1:	e9 37 f9 ff ff       	jmp    8010550d <alltraps>
...
80105bd8:	6a 40                	push   $0x40
  jmp alltraps
80105bda:	e9 2e f9 ff ff       	jmp    8010550d <alltraps>
...
80105be1:	6a 41                	push   $0x41
  jmp alltraps
80105be3:	e9 25 f9 ff ff       	jmp    8010550d <alltraps>
...
80105bea:	6a 42                	push   $0x42
  jmp alltraps
80105bec:	e9 1c f9 ff ff       	jmp    8010550d <alltraps>
...
80105bf3:	6a 43                	push   $0x43
  jmp alltraps
80105bf5:	e9 13 f9 ff ff       	jmp    8010550d <alltraps>
...
80105bfc:	6a 44                	push   $0x44
  jmp alltraps
80105bfe:	e9 0a f9 ff ff       	jmp    8010550d <alltraps>
...
80105c05:	6a 45                	push   $0x45
  jmp alltraps
80105c07:	e9 01 f9 ff ff       	jmp    8010550d <alltraps>
...
80105c0e:	6a 46                	push   $0x46
  jmp alltraps
80105c10:	e9 f8 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c17:	6a 47                	push   $0x47
  jmp alltraps
80105c19:	e9 ef f8 ff ff       	jmp    8010550d <alltraps>
...
80105c20:	6a 48                	push   $0x48
  jmp alltraps
80105c22:	e9 e6 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c29:	6a 49                	push   $0x49
  jmp alltraps
80105c2b:	e9 dd f8 ff ff       	jmp    8010550d <alltraps>
...
80105c32:	6a 4a                	push   $0x4a
  jmp alltraps
80105c34:	e9 d4 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c3b:	6a 4b                	push   $0x4b
  jmp alltraps
80105c3d:	e9 cb f8 ff ff       	jmp    8010550d <alltraps>
...
80105c44:	6a 4c                	push   $0x4c
  jmp alltraps
80105c46:	e9 c2 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c4d:	6a 4d                	push   $0x4d
  jmp alltraps
80105c4f:	e9 b9 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c56:	6a 4e                	push   $0x4e
  jmp alltraps
80105c58:	e9 b0 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c5f:	6a 4f                	push   $0x4f
  jmp alltraps
80105c61:	e9 a7 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c68:	6a 50                	push   $0x50
  jmp alltraps
80105c6a:	e9 9e f8 ff ff       	jmp    8010550d <alltraps>
...
80105c71:	6a 51                	push   $0x51
  jmp alltraps
80105c73:	e9 95 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c7a:	6a 52                	push   $0x52
  jmp alltraps
80105c7c:	e9 8c f8 ff ff       	jmp    8010550d <alltraps>
...
80105c83:	6a 53                	push   $0x53
  jmp alltraps
80105c85:	e9 83 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c8c:	6a 54                	push   $0x54
  jmp alltraps
80105c8e:	e9 7a f8 ff ff       	jmp    8010550d <alltraps>
...
80105c95:	6a 55                	push   $0x55
  jmp alltraps
80105c97:	e9 71 f8 ff ff       	jmp    8010550d <alltraps>
...
80105c9e:	6a 56                	push   $0x56
  jmp alltraps
80105ca0:	e9 68 f8 ff ff       	jmp    8010550d <alltraps>
...
80105ca7:	6a 57                	push   $0x57
  jmp alltraps
80105ca9:	e9 5f f8 ff ff       	jmp    8010550d <alltraps>
...
80105cb0:	6a 58                	push   $0x58
  jmp alltraps
80105cb2:	e9 56 f8 ff ff       	jmp    8010550d <alltraps>
...
80105cb9:	6a 59                	push   $0x59
  jmp alltraps
80105cbb:	e9 4d f8 ff ff       	jmp    8010550d <alltraps>
...
80105cc2:	6a 5a                	push   $0x5a
  jmp alltraps
80105cc4:	e9 44 f8 ff ff       	jmp    8010550d <alltraps>
...
80105ccb:	6a 5b                	push   $0x5b
  jmp alltraps
80105ccd:	e9 3b f8 ff ff       	jmp    8010550d <alltraps>
...
80105cd4:	6a 5c                	push   $0x5c
  jmp alltraps
80105cd6:	e9 32 f8 ff ff       	jmp    8010550d <alltraps>
...
80105cdd:	6a 5d                	push   $0x5d
  jmp alltraps
80105cdf:	e9 29 f8 ff ff       	jmp    8010550d <alltraps>
...
80105ce6:	6a 5e                	push   $0x5e
  jmp alltraps
80105ce8:	e9 20 f8 ff ff       	jmp    8010550d <alltraps>
...
80105cef:	6a 5f                	push   $0x5f
  jmp alltraps
80105cf1:	e9 17 f8 ff ff       	jmp    8010550d <alltraps>
...
80105cf8:	6a 60                	push   $0x60
  jmp alltraps
80105cfa:	e9 0e f8 ff ff       	jmp    8010550d <alltraps>
...
80105d01:	6a 61                	push   $0x61
  jmp alltraps
80105d03:	e9 05 f8 ff ff       	jmp    8010550d <alltraps>
...
80105d0a:	6a 62                	push   $0x62
  jmp alltraps
80105d0c:	e9 fc f7 ff ff       	jmp    8010550d <alltraps>
...
80105d13:	6a 63                	push   $0x63
  jmp alltraps
80105d15:	e9 f3 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d1c:	6a 64                	push   $0x64
  jmp alltraps
80105d1e:	e9 ea f7 ff ff       	jmp    8010550d <alltraps>
...
80105d25:	6a 65                	push   $0x65
  jmp alltraps
80105d27:	e9 e1 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d2e:	6a 66                	push   $0x66
  jmp alltraps
80105d30:	e9 d8 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d37:	6a 67                	push   $0x67
  jmp alltraps
80105d39:	e9 cf f7 ff ff       	jmp    8010550d <alltraps>
...
80105d40:	6a 68                	push   $0x68
  jmp alltraps
80105d42:	e9 c6 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d49:	6a 69                	push   $0x69
  jmp alltraps
80105d4b:	e9 bd f7 ff ff       	jmp    8010550d <alltraps>
...
80105d52:	6a 6a                	push   $0x6a
  jmp alltraps
80105d54:	e9 b4 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d5b:	6a 6b                	push   $0x6b
  jmp alltraps
80105d5d:	e9 ab f7 ff ff       	jmp    8010550d <alltraps>
...
80105d64:	6a 6c                	push   $0x6c
  jmp alltraps
80105d66:	e9 a2 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d6d:	6a 6d                	push   $0x6d
  jmp alltraps
80105d6f:	e9 99 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d76:	6a 6e                	push   $0x6e
  jmp alltraps
80105d78:	e9 90 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d7f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d81:	e9 87 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d88:	6a 70                	push   $0x70
  jmp alltraps
80105d8a:	e9 7e f7 ff ff       	jmp    8010550d <alltraps>
...
80105d91:	6a 71                	push   $0x71
  jmp alltraps
80105d93:	e9 75 f7 ff ff       	jmp    8010550d <alltraps>
...
80105d9a:	6a 72                	push   $0x72
  jmp alltraps
80105d9c:	e9 6c f7 ff ff       	jmp    8010550d <alltraps>
...
80105da3:	6a 73                	push   $0x73
  jmp alltraps
80105da5:	e9 63 f7 ff ff       	jmp    8010550d <alltraps>
...
80105dac:	6a 74                	push   $0x74
  jmp alltraps
80105dae:	e9 5a f7 ff ff       	jmp    8010550d <alltraps>
...
80105db5:	6a 75                	push   $0x75
  jmp alltraps
80105db7:	e9 51 f7 ff ff       	jmp    8010550d <alltraps>
...
80105dbe:	6a 76                	push   $0x76
  jmp alltraps
80105dc0:	e9 48 f7 ff ff       	jmp    8010550d <alltraps>
...
80105dc7:	6a 77                	push   $0x77
  jmp alltraps
80105dc9:	e9 3f f7 ff ff       	jmp    8010550d <alltraps>
...
80105dd0:	6a 78                	push   $0x78
  jmp alltraps
80105dd2:	e9 36 f7 ff ff       	jmp    8010550d <alltraps>
...
80105dd9:	6a 79                	push   $0x79
  jmp alltraps
80105ddb:	e9 2d f7 ff ff       	jmp    8010550d <alltraps>
...
80105de2:	6a 7a                	push   $0x7a
  jmp alltraps
80105de4:	e9 24 f7 ff ff       	jmp    8010550d <alltraps>
...
80105deb:	6a 7b                	push   $0x7b
  jmp alltraps
80105ded:	e9 1b f7 ff ff       	jmp    8010550d <alltraps>
...
80105df4:	6a 7c                	push   $0x7c
  jmp alltraps
80105df6:	e9 12 f7 ff ff       	jmp    8010550d <alltraps>
...
80105dfd:	6a 7d                	push   $0x7d
  jmp alltraps
80105dff:	e9 09 f7 ff ff       	jmp    8010550d <alltraps>
...
80105e06:	6a 7e                	push   $0x7e
  jmp alltraps
80105e08:	e9 00 f7 ff ff       	jmp    8010550d <alltraps>
...
80105e0f:	6a 7f                	push   $0x7f
  jmp alltraps
80105e11:	e9 f7 f6 ff ff       	jmp    8010550d <alltraps>
...
80105e18:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105e1d:	e9 eb f6 ff ff       	jmp    8010550d <alltraps>
...
80105e24:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105e29:	e9 df f6 ff ff       	jmp    8010550d <alltraps>
...
80105e30:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105e35:	e9 d3 f6 ff ff       	jmp    8010550d <alltraps>
...
80105e3c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105e41:	e9 c7 f6 ff ff       	jmp    8010550d <alltraps>
...
80105e48:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105e4d:	e9 bb f6 ff ff       	jmp    8010550d <alltraps>
...
80105e54:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105e59:	e9 af f6 ff ff       	jmp    8010550d <alltraps>
...
80105e60:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105e65:	e9 a3 f6 ff ff       	jmp    8010550d <alltraps>
...
80105e6c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e71:	e9 97 f6 ff ff       	jmp    8010550d <alltraps>
...
80105e78:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e7d:	e9 8b f6 ff ff       	jmp    8010550d <alltraps>
...
80105e84:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e89:	e9 7f f6 ff ff       	jmp    8010550d <alltraps>
...
80105e90:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105e95:	e9 73 f6 ff ff       	jmp    8010550d <alltraps>
...
80105e9c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105ea1:	e9 67 f6 ff ff       	jmp    8010550d <alltraps>
...
80105ea8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105ead:	e9 5b f6 ff ff       	jmp    8010550d <alltraps>
...
80105eb4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105eb9:	e9 4f f6 ff ff       	jmp    8010550d <alltraps>
...
80105ec0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105ec5:	e9 43 f6 ff ff       	jmp    8010550d <alltraps>
...
80105ecc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105ed1:	e9 37 f6 ff ff       	jmp    8010550d <alltraps>
...
80105ed8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105edd:	e9 2b f6 ff ff       	jmp    8010550d <alltraps>
...
80105ee4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105ee9:	e9 1f f6 ff ff       	jmp    8010550d <alltraps>
...
80105ef0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105ef5:	e9 13 f6 ff ff       	jmp    8010550d <alltraps>
...
80105efc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105f01:	e9 07 f6 ff ff       	jmp    8010550d <alltraps>
...
80105f08:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105f0d:	e9 fb f5 ff ff       	jmp    8010550d <alltraps>
...
80105f14:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105f19:	e9 ef f5 ff ff       	jmp    8010550d <alltraps>
...
80105f20:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105f25:	e9 e3 f5 ff ff       	jmp    8010550d <alltraps>
...
80105f2c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105f31:	e9 d7 f5 ff ff       	jmp    8010550d <alltraps>
...
80105f38:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105f3d:	e9 cb f5 ff ff       	jmp    8010550d <alltraps>
...
80105f44:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105f49:	e9 bf f5 ff ff       	jmp    8010550d <alltraps>
...
80105f50:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105f55:	e9 b3 f5 ff ff       	jmp    8010550d <alltraps>
...
80105f5c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105f61:	e9 a7 f5 ff ff       	jmp    8010550d <alltraps>
...
80105f68:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105f6d:	e9 9b f5 ff ff       	jmp    8010550d <alltraps>
...
80105f74:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f79:	e9 8f f5 ff ff       	jmp    8010550d <alltraps>
...
80105f80:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f85:	e9 83 f5 ff ff       	jmp    8010550d <alltraps>
...
80105f8c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105f91:	e9 77 f5 ff ff       	jmp    8010550d <alltraps>
...
80105f98:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105f9d:	e9 6b f5 ff ff       	jmp    8010550d <alltraps>
...
80105fa4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105fa9:	e9 5f f5 ff ff       	jmp    8010550d <alltraps>
...
80105fb0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105fb5:	e9 53 f5 ff ff       	jmp    8010550d <alltraps>
...
80105fbc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105fc1:	e9 47 f5 ff ff       	jmp    8010550d <alltraps>
...
80105fc8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105fcd:	e9 3b f5 ff ff       	jmp    8010550d <alltraps>
...
80105fd4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105fd9:	e9 2f f5 ff ff       	jmp    8010550d <alltraps>
...
80105fe0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105fe5:	e9 23 f5 ff ff       	jmp    8010550d <alltraps>
...
80105fec:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105ff1:	e9 17 f5 ff ff       	jmp    8010550d <alltraps>
...
80105ff8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105ffd:	e9 0b f5 ff ff       	jmp    8010550d <alltraps>
...
80106004:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106009:	e9 ff f4 ff ff       	jmp    8010550d <alltraps>
...
80106010:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106015:	e9 f3 f4 ff ff       	jmp    8010550d <alltraps>
...
8010601c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106021:	e9 e7 f4 ff ff       	jmp    8010550d <alltraps>
...
80106028:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010602d:	e9 db f4 ff ff       	jmp    8010550d <alltraps>
...
80106034:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106039:	e9 cf f4 ff ff       	jmp    8010550d <alltraps>
...
80106040:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106045:	e9 c3 f4 ff ff       	jmp    8010550d <alltraps>
...
8010604c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106051:	e9 b7 f4 ff ff       	jmp    8010550d <alltraps>
...
80106058:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010605d:	e9 ab f4 ff ff       	jmp    8010550d <alltraps>
...
80106064:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106069:	e9 9f f4 ff ff       	jmp    8010550d <alltraps>
...
80106070:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106075:	e9 93 f4 ff ff       	jmp    8010550d <alltraps>
...
8010607c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106081:	e9 87 f4 ff ff       	jmp    8010550d <alltraps>
...
80106088:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010608d:	e9 7b f4 ff ff       	jmp    8010550d <alltraps>
...
80106094:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106099:	e9 6f f4 ff ff       	jmp    8010550d <alltraps>
...
801060a0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801060a5:	e9 63 f4 ff ff       	jmp    8010550d <alltraps>
...
801060ac:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801060b1:	e9 57 f4 ff ff       	jmp    8010550d <alltraps>
...
801060b8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801060bd:	e9 4b f4 ff ff       	jmp    8010550d <alltraps>
...
801060c4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801060c9:	e9 3f f4 ff ff       	jmp    8010550d <alltraps>
...
801060d0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801060d5:	e9 33 f4 ff ff       	jmp    8010550d <alltraps>
...
801060dc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801060e1:	e9 27 f4 ff ff       	jmp    8010550d <alltraps>
...
801060e8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801060ed:	e9 1b f4 ff ff       	jmp    8010550d <alltraps>
...
801060f4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801060f9:	e9 0f f4 ff ff       	jmp    8010550d <alltraps>
...
80106100:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106105:	e9 03 f4 ff ff       	jmp    8010550d <alltraps>
...
8010610c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106111:	e9 f7 f3 ff ff       	jmp    8010550d <alltraps>
...
80106118:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010611d:	e9 eb f3 ff ff       	jmp    8010550d <alltraps>
...
80106124:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106129:	e9 df f3 ff ff       	jmp    8010550d <alltraps>
...
80106130:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106135:	e9 d3 f3 ff ff       	jmp    8010550d <alltraps>
...
8010613c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106141:	e9 c7 f3 ff ff       	jmp    8010550d <alltraps>
...
80106148:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010614d:	e9 bb f3 ff ff       	jmp    8010550d <alltraps>
...
80106154:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106159:	e9 af f3 ff ff       	jmp    8010550d <alltraps>
...
80106160:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106165:	e9 a3 f3 ff ff       	jmp    8010550d <alltraps>
...
8010616c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106171:	e9 97 f3 ff ff       	jmp    8010550d <alltraps>
...
80106178:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010617d:	e9 8b f3 ff ff       	jmp    8010550d <alltraps>
...
80106184:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106189:	e9 7f f3 ff ff       	jmp    8010550d <alltraps>
...
80106190:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106195:	e9 73 f3 ff ff       	jmp    8010550d <alltraps>
...
8010619c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801061a1:	e9 67 f3 ff ff       	jmp    8010550d <alltraps>
...
801061a8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801061ad:	e9 5b f3 ff ff       	jmp    8010550d <alltraps>
...
801061b4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801061b9:	e9 4f f3 ff ff       	jmp    8010550d <alltraps>
...
801061c0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801061c5:	e9 43 f3 ff ff       	jmp    8010550d <alltraps>
...
801061cc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801061d1:	e9 37 f3 ff ff       	jmp    8010550d <alltraps>
...
801061d8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801061dd:	e9 2b f3 ff ff       	jmp    8010550d <alltraps>
...
801061e4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801061e9:	e9 1f f3 ff ff       	jmp    8010550d <alltraps>
...
801061f0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801061f5:	e9 13 f3 ff ff       	jmp    8010550d <alltraps>
...
801061fc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106201:	e9 07 f3 ff ff       	jmp    8010550d <alltraps>
...
80106208:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010620d:	e9 fb f2 ff ff       	jmp    8010550d <alltraps>
...
80106214:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106219:	e9 ef f2 ff ff       	jmp    8010550d <alltraps>
...
80106220:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106225:	e9 e3 f2 ff ff       	jmp    8010550d <alltraps>
...
8010622c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106231:	e9 d7 f2 ff ff       	jmp    8010550d <alltraps>
...
80106238:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010623d:	e9 cb f2 ff ff       	jmp    8010550d <alltraps>
...
80106244:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106249:	e9 bf f2 ff ff       	jmp    8010550d <alltraps>
...
80106250:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106255:	e9 b3 f2 ff ff       	jmp    8010550d <alltraps>
...
8010625c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106261:	e9 a7 f2 ff ff       	jmp    8010550d <alltraps>
...
80106268:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010626d:	e9 9b f2 ff ff       	jmp    8010550d <alltraps>
...
80106274:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106279:	e9 8f f2 ff ff       	jmp    8010550d <alltraps>
...
80106280:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106285:	e9 83 f2 ff ff       	jmp    8010550d <alltraps>
...
8010628c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106291:	e9 77 f2 ff ff       	jmp    8010550d <alltraps>
...
80106298:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010629d:	e9 6b f2 ff ff       	jmp    8010550d <alltraps>
...
801062a4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801062a9:	e9 5f f2 ff ff       	jmp    8010550d <alltraps>
...
801062b0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801062b5:	e9 53 f2 ff ff       	jmp    8010550d <alltraps>
...
801062bc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801062c1:	e9 47 f2 ff ff       	jmp    8010550d <alltraps>
...
801062c8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801062cd:	e9 3b f2 ff ff       	jmp    8010550d <alltraps>
...
801062d4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801062d9:	e9 2f f2 ff ff       	jmp    8010550d <alltraps>
...
801062e0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801062e5:	e9 23 f2 ff ff       	jmp    8010550d <alltraps>
...
801062ec:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801062f1:	e9 17 f2 ff ff       	jmp    8010550d <alltraps>
...
801062f8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801062fd:	e9 0b f2 ff ff       	jmp    8010550d <alltraps>
...
80106304:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106309:	e9 ff f1 ff ff       	jmp    8010550d <alltraps>
...
80106310:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106315:	e9 f3 f1 ff ff       	jmp    8010550d <alltraps>
...
8010631c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106321:	e9 e7 f1 ff ff       	jmp    8010550d <alltraps>
...
80106328:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010632d:	e9 db f1 ff ff       	jmp    8010550d <alltraps>
...
80106334:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106339:	e9 cf f1 ff ff       	jmp    8010550d <alltraps>
...
80106340:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106345:	e9 c3 f1 ff ff       	jmp    8010550d <alltraps>
...
8010634c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106351:	e9 b7 f1 ff ff       	jmp    8010550d <alltraps>
...
80106358:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010635d:	e9 ab f1 ff ff       	jmp    8010550d <alltraps>
...
80106364:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106369:	e9 9f f1 ff ff       	jmp    8010550d <alltraps>
...
80106370:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106375:	e9 93 f1 ff ff       	jmp    8010550d <alltraps>
...
8010637c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106381:	e9 87 f1 ff ff       	jmp    8010550d <alltraps>
...
80106388:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010638d:	e9 7b f1 ff ff       	jmp    8010550d <alltraps>
...
80106394:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106399:	e9 6f f1 ff ff       	jmp    8010550d <alltraps>
...
801063a0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801063a5:	e9 63 f1 ff ff       	jmp    8010550d <alltraps>
...
801063ac:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801063b1:	e9 57 f1 ff ff       	jmp    8010550d <alltraps>
...
801063b8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801063bd:	e9 4b f1 ff ff       	jmp    8010550d <alltraps>
...
801063c4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801063c9:	e9 3f f1 ff ff       	jmp    8010550d <alltraps>
...
801063d0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801063d5:	e9 33 f1 ff ff       	jmp    8010550d <alltraps>
...
801063dc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801063e1:	e9 27 f1 ff ff       	jmp    8010550d <alltraps>
...
801063e8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801063ed:	e9 1b f1 ff ff       	jmp    8010550d <alltraps>
...
801063f4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801063f9:	e9 0f f1 ff ff       	jmp    8010550d <alltraps>
...
80106400:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106405:	e9 03 f1 ff ff       	jmp    8010550d <alltraps>
...
8010640c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106411:	e9 f7 f0 ff ff       	jmp    8010550d <alltraps>
...
80106464:	e8 37 c0 ff ff       	call   801024a0 <kalloc>
...
8010653a:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
8010653b:	c7 04 24 06 71 10 80 	movl   $0x80107106,(%esp)
...
80106681:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106682:	c7 04 24 10 78 10 80 	movl   $0x80107810,(%esp)
...
80106690:	a1 a4 55 11 80       	mov    0x801155a4,%eax
...
80106739:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010673e:	e8 bd ce ff ff       	call   80103600 <mycpu>
80106743:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010674a:	e8 b1 ce ff ff       	call   80103600 <mycpu>
...
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106791:	c7 04 24 16 78 10 80 	movl   $0x80107816,(%esp)
80106798:	e8 c3 9b ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010679d:	c7 04 24 41 78 10 80 	movl   $0x80107841,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
801067a9:	c7 04 24 2c 78 10 80 	movl   $0x8010782c,(%esp)
...
801067da:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  mem = kalloc();
801067dd:	e8 be bc ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
inituvm(pde_t *pgdir, char *init, uint sz)
{
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
8010683e:	c7 04 24 55 78 10 80 	movl   $0x80107855,(%esp)
...
801068f1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801068f2:	c7 04 24 6f 78 10 80 	movl   $0x8010786f,(%esp)
801068f9:	e8 62 9a ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
801068fe:	c7 04 24 10 79 10 80 	movl   $0x80107910,(%esp)
...
80106995:	76 29                	jbe    801069c0 <allocuvm+0xb0>
    mem = kalloc();
80106997:	e8 04 bb ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
801069a0:	75 a6                	jne    80106948 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
801069a2:	c7 04 24 8d 78 10 80 	movl   $0x8010788d,(%esp)
...
801069ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
801069d0:	c7 04 24 a5 78 10 80 	movl   $0x801078a5,(%esp)
...
801069f1:	e8 fa b8 ff ff       	call   801022f0 <kfree>
      return 0;
...
80106a7d:	e8 6e b8 ff ff       	call   801022f0 <kfree>
  uint i;
...
80106a92:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106a93:	e9 58 b8 ff ff       	jmp    801022f0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106a98:	c7 04 24 c1 78 10 80 	movl   $0x801078c1,(%esp)
...
80106ab8:	e8 e3 b9 ff ff       	call   801024a0 <kalloc>
...
80106b4b:	a3 a4 55 11 80       	mov    %eax,0x801155a4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80106b7b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106b7c:	c7 04 24 d2 78 10 80 	movl   $0x801078d2,(%esp)
...
80106b96:	83 ec 2c             	sub    $0x2c,%esp
  ...
  char *mem;
  struct proc *curproc = myproc();
80106b99:	e8 02 cb ff ff       	call   801036a0 <myproc>
80106b9e:	89 45 dc             	mov    %eax,-0x24(%ebp)

  if((d = setupkvm()) == 0)
80106ba1:	e8 0a ff ff ff       	call   80106ab0 <setupkvm>
80106ba6:	85 c0                	test   %eax,%eax
80106ba8:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106bab:	0f 84 6d 01 00 00    	je     80106d1e <copyuvm+0x18e>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106bb1:	8b 45 0c             	mov    0xc(%ebp),%eax
80106bb4:	85 c0                	test   %eax,%eax
80106bb6:	0f 84 57 01 00 00    	je     80106d13 <copyuvm+0x183>
80106bbc:	31 db                	xor    %ebx,%ebx
80106bbe:	eb 51                	jmp    80106c11 <copyuvm+0x81>
...
80106bc0:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106bc6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106bcd:	00 
80106bce:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106bd2:	89 04 24             	mov    %eax,(%esp)
80106bd5:	e8 46 d7 ff ff       	call   80104320 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106bda:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106bdd:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106be3:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106be7:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106bee:	00 
80106bef:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106bf3:	89 44 24 10          	mov    %eax,0x10(%esp)
80106bf7:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106bfa:	89 04 24             	mov    %eax,(%esp)
80106bfd:	e8 0e fa ff ff       	call   80106610 <mappages>
80106c02:	85 c0                	test   %eax,%eax
80106c04:	78 4d                	js     80106c53 <copyuvm+0xc3>
  char *mem;
  struct proc *curproc = myproc();
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106c06:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c0c:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106c0f:	76 57                	jbe    80106c68 <copyuvm+0xd8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c11:	8b 45 08             	mov    0x8(%ebp),%eax
80106c14:	31 c9                	xor    %ecx,%ecx
80106c16:	89 da                	mov    %ebx,%edx
80106c18:	e8 03 f8 ff ff       	call   80106420 <walkpgdir>
80106c1d:	85 c0                	test   %eax,%eax
80106c1f:	0f 84 0c 01 00 00    	je     80106d31 <copyuvm+0x1a1>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106c25:	8b 30                	mov    (%eax),%esi
80106c27:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c2d:	0f 84 f2 00 00 00    	je     80106d25 <copyuvm+0x195>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c33:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c35:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c3b:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c3e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106c44:	e8 57 b8 ff ff       	call   801024a0 <kalloc>
80106c49:	85 c0                	test   %eax,%eax
80106c4b:	89 c6                	mov    %eax,%esi
80106c4d:	0f 85 6d ff ff ff    	jne    80106bc0 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
bad:
  freevm(d);
80106c53:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c56:	89 04 24             	mov    %eax,(%esp)
80106c59:	e8 d2 fd ff ff       	call   80106a30 <freevm>
  return 0;
80106c5e:	31 c0                	xor    %eax,%eax
}
...
80106c67:	c3                   	ret    
  ...
  for(i = sz; i >  curproc->stack_size ; i -= PGSIZE){
80106c68:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106c6b:	8b 40 7c             	mov    0x7c(%eax),%eax
80106c6e:	39 45 0c             	cmp    %eax,0xc(%ebp)
80106c71:	0f 86 9c 00 00 00    	jbe    80106d13 <copyuvm+0x183>
80106c77:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80106c7a:	eb 58                	jmp    80106cd4 <copyuvm+0x144>
...
80106cbd:	e8 4e f9 ff ff       	call   80106610 <mappages>
80106cc2:	85 c0                	test   %eax,%eax
80106cc4:	78 8d                	js     80106c53 <copyuvm+0xc3>
    memmove(mem, (char*)P2V(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
      goto bad;
  }
  ...
  for(i = sz; i >  curproc->stack_size ; i -= PGSIZE){
80106cc6:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106cc9:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106ccf:	39 58 7c             	cmp    %ebx,0x7c(%eax)
80106cd2:	73 3f                	jae    80106d13 <copyuvm+0x183>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106cd4:	8b 45 08             	mov    0x8(%ebp),%eax
80106cd7:	31 c9                	xor    %ecx,%ecx
80106cd9:	89 da                	mov    %ebx,%edx
80106cdb:	e8 40 f7 ff ff       	call   80106420 <walkpgdir>
80106ce0:	85 c0                	test   %eax,%eax
80106ce2:	74 4d                	je     80106d31 <copyuvm+0x1a1>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106ce4:	8b 30                	mov    (%eax),%esi
80106ce6:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106cec:	74 37                	je     80106d25 <copyuvm+0x195>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
...
80106d20:	e9 3b ff ff ff       	jmp    80106c60 <copyuvm+0xd0>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106d25:	c7 04 24 f6 78 10 80 	movl   $0x801078f6,(%esp)
80106d2c:	e8 2f 96 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106d31:	c7 04 24 dc 78 10 80 	movl   $0x801078dc,(%esp)
...
80106d4e:	e8 cd f6 ff ff       	call   80106420 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106dbc:	e8 5f d5 ff ff       	call   80104320 <memmove>
    len -= n;
    buf += n;
...
80106e16:	c7 44 24 04 34 79 10 	movl   $0x80107934,0x4(%esp)
80106e1d:	80 
80106e1e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e25:	e8 26 d2 ff ff       	call   80104050 <initlock>
  acquire(&(shm_table.lock));
80106e2a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e31:	e8 0a d3 ff ff       	call   80104140 <acquire>
80106e36:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
80106e3b:	90                   	nop
80106e3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (i = 0; i< 64; i++) {
    shm_table.shm_pages[i].id =0;
80106e40:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106e46:	83 c0 0c             	add    $0xc,%eax
    shm_table.shm_pages[i].frame =0;
80106e49:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
    shm_table.shm_pages[i].refcnt =0;
80106e50:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
...
void shminit() {
  ...
  acquire(&(shm_table.lock));
  for (i = 0; i< 64; i++) {
80106e57:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
80106e5c:	75 e2                	jne    80106e40 <shminit+0x30>
    shm_table.shm_pages[i].id =0;
    shm_table.shm_pages[i].frame =0;
    shm_table.shm_pages[i].refcnt =0;
  }
  release(&(shm_table.lock));
80106e5e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e65:	e8 c6 d3 ff ff       	call   80104230 <release>
}
80106e6a:	c9                   	leave  
80106e6b:	c3                   	ret    
